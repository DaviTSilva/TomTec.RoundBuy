...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.OfficialIdentificationType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 975, DateTimeKind.Utc).AddTicks(7416),
                            Name = "CPF"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 975, DateTimeKind.Utc).AddTicks(7824),
                            Name = "CPNJ"
                        });
                });
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.PaymentMethod", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 977, DateTimeKind.Utc).AddTicks(8577),
                            Name = "CreditCard"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 977, DateTimeKind.Utc).AddTicks(8720),
                            Name = "Boleto"
                        },
                        new
                        {
                            Id = 3,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 977, DateTimeKind.Utc).AddTicks(8761),
                            Name = "Pix"
                        });
                });
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.UserLikesOnAnnouncement", b =>
                {
                    ...
                    b.ToTable("UserLikesOnAnnouncements");
                });

            modelBuilder.Entity("TomTec.RoundBuy.Models.UserLikesOnComment", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("UserLikesOnComments");
                });

            modelBuilder.Entity("TomTec.RoundBuy.Models.UserLikesOnRating", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.UserType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 976, DateTimeKind.Utc).AddTicks(7666),
                            Name = "Prod"
                        },
                        new
                        {
                            Id = 2,
                            CreationDate = new DateTime(2023, 5, 3, 15, 14, 2, 976, DateTimeKind.Utc).AddTicks(7879),
                            Name = "Test"
                        });
                });
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.Announcement", b =>
                {
                    ...
                    b.HasOne("TomTec.RoundBuy.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.UserLikesOnAnnouncement", b =>
                {
                    b.HasOne("TomTec.RoundBuy.Models.Announcement", "Announcement")
                        .WithMany("UserLikesOnAnnouncements")
                        .HasForeignKey("AnnouncementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.UserLikesOnComment", b =>
                {
                    b.HasOne("TomTec.RoundBuy.Models.Comment", "Comment")
                        .WithMany("UserLikesOnComments")
            ...
            modelBuilder.Entity("TomTec.RoundBuy.Models.UserLikesOnRating", b =>
                {
                    b.HasOne("TomTec.RoundBuy.Models.Rating", "Rating")
                        .WithMany("UserLikesOnRatings")
